...
import softwareDevelopment from '../data/sorftware-development'

function SorftwareDevelopment() {

  return (
    <>
    {
      softwareDevelopment.map((data)=>{
        return(
          <>
            <ServiceHeroSection 
...
export default SorftwareDevelopment