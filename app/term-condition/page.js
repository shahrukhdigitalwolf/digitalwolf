...
import ServicesHeroSection from './termsHeroSection'
    ...
    <>
      ...
      <div className='my-10'>
        <div className='mx-auto px-28 mb-5'>
          <h1 className='border-b border-gray-700 text-2xl font-bold'>Overview</h1>
          <hr />
        </div>
        <div className='mx-auto px-28 mb-10'>
          <ul className="list-disc pl-5">
            <li>This website is operated by DIGITAL WOLF. Throughout the site, the terms “we”, “us” and “our” refer to Digital Wolf. Digital Wolf offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.</li>
        ...
        <div className='mx-auto px-28 mb-5'>
          <h1 className='border-b border-gray-700 text-2xl font-bold'>Online Store Terms</h1>
          <hr />
        </div>
        <div className='mx-auto px-28 mb-10'>
          <ul className="list-disc pl-5">
        ...
        <div className='mx-auto px-28 mb-5'>
          <h1 className='border-b border-gray-700 text-2xl font-bold'>General Conditions</h1>
          <hr />
        </div>
        <div className='mx-auto px-28 mb-10'>
          <ul className="list-disc pl-5">
        ...
        <div className='mx-auto px-28 mb-5'>
          <h1 className='border-b border-gray-700 text-2xl font-bold'>Accuracy, Completeness And Timelessness Of Information</h1>
          <hr />
        </div>
        <div className='mx-auto px-28 mb-10'>
          <ul className="list-disc pl-5">
        ...
        <div className='mx-auto px-28 mb-5'>
          <h1 className='border-b border-gray-700 text-2xl font-bold'>Modifications To The Service And Prices</h1>
          <hr />
        </div>
        <div className='mx-auto px-28 mb-10'>
          <ul className="list-disc pl-5">
        ...
        <div className='mx-auto px-28 mb-5'>
          <h1 className='border-b border-gray-700 text-2xl font-bold'>Products Or Services</h1>
          <hr />
        </div>
        <div className='mx-auto px-28 mb-10'>
          <ul className="list-disc pl-5">
        ...
        <div className='mx-auto px-28 mb-5'>
          <h1 className='border-b border-gray-700 text-2xl font-bold'>Accuracy Of Billing And Account Information</h1>
          <hr />
        </div>
        <div className='mx-auto px-28 mb-5'>
          <ul className="list-disc pl-10">
            ...
            <li><strong>For more detail, please review our Refund Policy.</strong></li>
          </ul>
        </div>

        <div className='mx-auto px-28 mb-5'>
          <h1 className='border-b border-gray-700 text-2xl font-bold'>Optional Tools</h1>
          <hr />
        </div>
        <div className='mx-auto px-28 mb-10'>
          <ul className="list-disc pl-5">
        ...
        <div className='mx-auto px-28 mb-5'>
          <h1 className='border-b border-gray-700 text-2xl font-bold'>Third-Party Links</h1>
          <hr />
        </div>
        <div className='mx-auto px-28 mb-10'>
          <ul className="list-disc pl-5">
