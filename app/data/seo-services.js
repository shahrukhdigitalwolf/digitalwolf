const seoServicess = [
    {
        headText1 : '[SEO Details Page]',
        headText2 : 'Search Engine Optimization',
        headText3 : 'Learn how to optimize search engines with the best SEO company in Kolkata.',
        featureImg : '/img/services/business-people-working-laptop-meeting.jpg',

        ourServicesText1 : 'Our job is to provide you with the most affordable SEO services in Kolkata',
        ourServicesText2 : 'Digital Wolf, is an affordable SEO company in Kolkata. We believe in support and delivery to our customers. We always worked as a team in our journey of more than 8 years. Our main goal is to understand the problems of our clients and give them perfect solutions. It is the main reason behind the success of both organizations. ',
        ...
        ourServicesText3 : 'Get In Touch with the Best Local SEO Service, in Kolkata ',
        ourServicesText4 : 'We will let your website to the best rank in terms of credibility. We are here to use the best SEO services, India to promote your brand or company and help you get more innovative. Our company provides you with the best online advertising services to elevate the growth of your company. We review customer’s behavior and analytical works to bring your app to their devices. Our applications have shown to be the best source of business lead generation because they have an improved user experience and a smooth interface.',

        ourServicesCardTextHead1 : '250+',
        ourServicesCardTextDesc1 : 'Clients Satisfied',

        ourServicesCardTextHead2 : 'Get result-',
        ourServicesCardTextDesc2 : 'driven strategies',

        ourServicesCardTextHead3 : 'Affordable',
        ourServicesCardTextDesc3 : 'SEO services',

        ourServicesCardTextHead4 : 'Offers',
