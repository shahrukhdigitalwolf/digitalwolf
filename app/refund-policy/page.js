...
import ServicesHeroSection from './refundHeroSection'
    ...
    <>
      ...
      <div className='my-10'>
        <div className='mx-auto px-28 mb-5'>
          <h1 className='border-b border-gray-700 text-2xl font-bold'>Returns</h1>
          <hr />
        </div>
        <div className='mx-auto px-28 mb-10'>
          <ul className="list-disc pl-5">
            ...
            <li>Additional non-returnable items:
              <ul>
                <li>A. Gift cards</li>
                <li>B. Downloadable software products</li>
                <li>C. Some health and personal care items</li>
              </ul>
            </li>
            <li>To complete your return, we require a receipt or proof of purchase.</li>
            <li>Please do not send your purchase back to the manufacturer.</li>
            <li>There are certain situations where only partial refunds are granted: (if applicable) Book with obvious signs of use CD, DVD, VHS tape, software, video game, cassette tape, or vinyl record that has been opened</li>
        ...
        <div className='mx-auto px-28 mb-5'>
          <h1 className='border-b border-gray-700 text-2xl font-bold'>Refunds (if applicable)</h1>
          <hr />
        </div>
        <div className='mx-auto px-28 mb-10'>
          <ul className="list-disc pl-5">
        ...
        <div className='mx-auto px-28 mb-5'>
          <h1 className='border-b border-gray-700 text-2xl font-bold'>Late or missing refunds (if applicable)</h1>
          <hr />
        </div>
        <div className='mx-auto px-28 mb-10'>
          <ul className="list-disc pl-5">
        ...
        <div className='mx-auto px-28 mb-5'>
          <h1 className='border-b border-gray-700 text-2xl font-bold'>Sale items (if applicable)</h1>
          <hr />
        </div>
        <div className='mx-auto px-28 mb-10'>
          <ul className="list-disc pl-5">
        ...
        <div className='mx-auto px-28 mb-5'>
          <h1 className='border-b border-gray-700 text-2xl font-bold'>Exchanges (if applicable)</h1>
          <hr />
        </div>
        <div className='mx-auto px-28 mb-10'>
          <ul className="list-disc pl-5">
            <li>We only replace items if they are defective or damaged. If you need to exchange it for the same item, send us an email at info@digitalwolf.co.in and send your item to: 22/263, Jodhpur Park, Tagore Park Road, Kolkata: 700045</li>
          </ul>
        </div>

        <div className='mx-auto px-28 mb-5'>
          <h1 className='border-b border-gray-700 text-2xl font-bold'>Gifts</h1>
          <hr />
        </div>
        <div className='mx-auto px-28 mb-10'>
          <ul className="list-disc pl-5">
        ...
        <div className='mx-auto px-28 mb-5'>
          <h1 className='border-b border-gray-700 text-2xl font-bold'>Shipping</h1>
          <hr />
        </div>
        <div className='mx-auto px-28 mb-5'>
